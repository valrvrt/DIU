...
Skipped: uses player_count=2 which GameSetup requires ≥3.
"""

import pytest
pytestmark = pytest.mark.skip(reason="Uses player_count=2 — GameSetup requires ≥3")
...
from src.loaders.leader_loader import load_leaders, get_leader_by_name
from src.models.leader import FeydRautha, GurneyHalleck, LadyAmberMetulli
